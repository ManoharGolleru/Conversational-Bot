...
session_keys = [
    ...
    'system_query_template', 'feedback_log'  # Added 'feedback_log'
]
...
with input_container:
    with st.form(key='query_form'):
        ...
        user_query = st.text_input(
            "💬 **User Query**",
            "",
            help="Enter your query here. For example: 'Tell me what caused this problem.'",
...
with st.form(key='feedback_form'):
    feedback = st.text_area(
        ...
        height=150,
        help="Share your thoughts on how we can improve the application."
    )
...
if submit_feedback:
    if feedback.strip():
        ...
        # Optionally, you can also save feedback to Git or another logging mechanism
